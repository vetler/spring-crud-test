...
public class EUserControllerUnitTest {
    ...
    public void whenCalledshowSignUpForm_thenCorrect() {
        EUser EUser = new EUser("John", "john@domain.com");

        assertThat(userController.showSignUpForm(EUser)).isEqualTo("add-user");
    }
    ...
    public void whenCalledaddUserAndValidUser_thenCorrect() {
        ...
        assertThat(userController.addUser(EUser, mockedBindingResult, mockedModel)).isEqualTo("redirect:/index");
    }
    ...
    public void whenCalledaddUserAndInValidUser_thenCorrect() {
        ...
        assertThat(userController.addUser(EUser, mockedBindingResult, mockedModel)).isEqualTo("add-user");
    }
    ...
    public void whenCalledupdateUserAndValidUser_thenCorrect() {
        ...
        assertThat(userController.updateUser(1l, EUser, mockedBindingResult, mockedModel)).isEqualTo("redirect:/index");
    }
    ...
    public void whenCalledupdateUserAndInValidUser_thenCorrect() {
        ...
        assertThat(userController.updateUser(1l, EUser, mockedBindingResult, mockedModel)).isEqualTo("update-user");
    }
